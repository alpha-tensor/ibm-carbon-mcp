...
export function registerPromptHandlers(server: Server, documentationService: DocumentationService) {
  ...
  server.setRequestHandler(GetPromptRequestSchema, async (request) => {
    ...
    const args = request.params.arguments as Record<string, string | undefined> | undefined;
    ...
    return response as any; // Typecast because MCP types can be strict about messages array
  });
}
